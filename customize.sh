...
# check
if [ ! -d /data/adb/modules/MiuiGalleryEditor ]; then
  ui_print "! Miui Gallery Editor Magisk Module is not installed."
  ui_print "  Edit option in Miui Gallery requires"
  ui_print "  Miui Gallery Editor Magisk Module."
  ui_print "  Please read the Github README installation guide!"
  ui_print " "
fi
